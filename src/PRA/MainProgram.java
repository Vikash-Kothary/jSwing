...
public class MainProgram {
	...
	public static void main(String[] args) {
		...
		Student Vikash = new Student("Vikash", "Kothary", "1462396", "vikash.kothary@kcl.ac.uk", null);
		Student Toby = new Student("Toby", "Birkett", "1431286", "toby.birkett@kcl.ac.uk", null);
